...
Supports:
- SwOS Lite (hex field IDs): CSS610-8G-2S+, CSS610-8P-2S+, etc.
- SwOS (descriptive field names): CRS305-1G-4S+, CRS310-8G+2S+, CSS326-24G-2S+, etc.

Model prefix does not determine the platform - CSS326 runs full SwOS.
